...
figure
plot(timeVect,push,'k','LineWidth',2);
hold on;
% plot(timeVect(1:end-1),release,'b--');
plot(timeVect,data.processedData.waveSpeed.unfilt.push{1,1},'r','LineWidth',0.5);
...
figure
plot(push,'k','LineWidth',2); hold on
plot(waveSpeed,'r','LineWidth',1)
% hold on;
% plot(timeVect(1:end-1),release,'b--');
% plot(timeVect,data.processedData.waveSpeed.unfilt.push{1,1},'r','LineWidth',0.5);
% plot(timeVect(1:end-1),data.processedData.waveSpeed.unfilt.release{1,1},'r--');
